...
export default function Landing() {
  ...
  return (
    <main className="min-h-screen bg-background-primary text-text-primary font-roboto flex flex-col">
      ...
      {/* HOW IT WORKS */}
      <section className="py-24 bg-background-secondary flex flex-col items-center text-center px-6">
        ...
        {(() => {
          const howItWorksSteps = [
            ...
            { icon: <FaShieldAlt />, title: "Dziel się Pewnie", desc: "W trudnej sytuacji każdy może zeskanować kod, by natychmiast zobaczyć Twoją kartę informacyjną." },
          ];
      ...
      <section className="py-20 bg-background-primary text-center px-6">
        <h2 className="text-4xl font-semibold mb-4 text-text-primary">Spokój ducha w Twojej kieszeni.</h2>
        <p className="text-text-secondary max-w-xl mx-auto mb-8">Gotów, by stworzyć swoją cyfrową siatkę bezpieczeństwa? Rozpoczęcie jest darmowe.</p>
      ...
      <footer className="bg-background-secondary border-t border-border-primary text-center py-6 px-6">
        <div className="container mx-auto">
          <p className="text-sm text-text-secondary">© {new Date().getFullYear()} ComfortApp. Wszelkie prawa zastrzeżone.</p>
